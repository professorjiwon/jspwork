...
<style>
	.divVeiw {width:450px; margin-top:10px; margin-left:40px;}
</style>
</head>
<body>
	<div align="center" class="divVeiw">   <!-- 부트스트랩은 전체화면을 차지하기 때문에 div를 넣어서 폭을 지정해줘야 원하는 폭지정 가능 -->
		<table class="table">
			<tr>
		...
		<%
			for(int i=0; i<alist.size(); i++) {
				...
				int rgb = r.nextInt(255*255*255);         // 랜덤으로 grb를 10진수로 추출하기
